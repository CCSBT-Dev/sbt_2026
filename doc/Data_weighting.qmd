...
![Workflow for weighting data components in stock assessment models.](data_weighting_workflow_infographic.png){#fig-data-weighting-workflow fig-alt="Infographic showing a stock assessment workflow for data weighting: inventory data, fit base model, diagnose conflict, choose weighting, refit and report, with common approaches and diagnostics."}
...
![Diagnosing lack-of-fit with Pearson and one-step-ahead residual diagnostics.](osa_residual_framework_infographic.png){#fig-osa-framework fig-alt="Infographic comparing traditional Pearson residual diagnostics with one-step-ahead residual diagnostics for stock-assessment composition data. Pearson residuals use marginal expectations and can show correlated, skewed residuals, while OSA residuals use sequential conditioning and randomized quantile residuals to support standard-normal Q-Q and SDNR diagnostics."}
